...
public abstract class AbstractNavigateToLibrarySourceTest : AbstractNavigateToLibraryTest() {
    ...
    private fun collectInterestingNavigationElements(): Collection<PsiElement> {
        return ContainerUtil.map<JetReference, PsiElement>(collectInterestingReferences(), object : Function<JetReference, PsiElement> {
            override fun `fun`(reference: JetReference): PsiElement {
