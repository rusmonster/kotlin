 ...
 *
 * @return a sequence of corresponding file lines. The sequence returned can be consumed only once.
 */
public fun BufferedReader.lines(): Sequence<String> = LinesSequence(this).asOneTimeConsumable()
