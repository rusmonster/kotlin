...
public data class JvmClasspathRoot(public override val file: File): JavaContentRoot

public data class JavaSourceRoot(public override val file: File): JavaContentRoot

public trait JavaContentRoot: ContentRoot {
...
public val CompilerConfiguration.jvmClasspathRoots: List<File>
    get() {
        return get(CommonConfigurationKeys.CONTENT_ROOTS)?.filterIsInstance<JvmClasspathRoot>()?.map { it.file } ?: listOf()
    }
